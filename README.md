...
{
    "require": {
       "ykushev/yii2-gearman": "dev-master"
    }
}
```
...
'components' => [
  'gearman' => [
      'class' => 'ykushev\yii2\gearman\GearmanComponent',
      'servers' => [
...
'controllerMap' => [
    'gearman' => [
        'class' => 'ykushev\yii2\gearman\GearmanController',
...
use ykushev\yii2\gearman\JobBase;
